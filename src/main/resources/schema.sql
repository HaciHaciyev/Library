...
Create table Book_Publisher (
    ...
    CONSTRAINT book_publisher_fk foreign key (book_id)
                            references Book (id),
    CONSTRAINT publisher_book_fk foreign key (publisher_id)
...
Create table Customer_Order (
    ...
    CONSTRAINT order_customer_fk foreign key (order_id)
                            references Order_Line (id)
);